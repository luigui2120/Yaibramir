...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-09-2021 a las 00:22:56
...
(1, '60306999855b', 'Mi Tienda', 'Venta productos abarrotes', 70003249, 'example@gmail.com', 'Centro comercial ', '0.00', 'logo_1ecbba73a7d407977168efe6aa146e4c.jpg', 'MXN');
...
(21, '1004', 'Gaseosa 500 ml', 17, '25.00', 22, 'img_abb2ec20f7ce38fa8dfae387a1f160d6.jpg', '2021-04-18 19:32:15', 1, 1),
...
(33, '1012', 'Chicharrones', 19, '25.50', 13, 'img_dbcd6e3c7056db0373cb82056059a07d.jpg', '2021-05-03 16:25:47', 1, 1),
...
(89, '2021-09-22 13:52:08', 1, 52, 1, '25.50'),
(90, '2021-09-22 14:43:24', 1, 52, 1, '50.50');
...
--
ALTER TABLE `detalle_temp`
  MODIFY `correlativo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=401;
...
--
ALTER TABLE `venta`
  MODIFY `noventa` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
