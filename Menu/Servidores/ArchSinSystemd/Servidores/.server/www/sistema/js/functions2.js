$(document).ready(function(){
   ...
   //Buscar Cliente
    ...
    $('#frmEmpresa').submit(function(e){
        ...
        if (intDni == '' || strNombreEmp == '' || intTelEmp == '' || strEmailEmp == '' || strDirEmp == '') {
    ...
    $('#nuevoCliente').click(function(e){
        ...
        $('.bodyModal').html('<form action="" method="post" name="form_add_product" id="form_add_product" onsubmit="event.preventDefault(); nuevoCliente();">'+                                           
                                            ...
                                            '<input type="text" name="DniCliente" id="DniCliente" value="" placeholder="Dni" required><br>'+
    ...
    $('#nuevoUsuario').click(function(e){
       ...
       $.ajax({
        ...
        $('.bodyModal').html('<form action="" method="post" name="form_add_product" id="form_add_product" onsubmit="event.preventDefault(); nuevoUsuario();">'+                                           
                                            ...
                                            '<input type="text" name="Dni" id="Dni" value="" placeholder="Dni" " onpaste="return false" required><br>'+
...
function listaCliente(pagina,busqueda){
            ...
            //console.log(response);            
                if (response != 'error') {
                    ...
                    $('.bodyModal').html('<form action="" method="post" name="form_add_product" id="form_add_product" onsubmit="event.preventDefault(); actualizarCliente();">'+
                                            ...
                                            '<input type="text" name="DniCliente" id="DniCliente" value="'+info.Dni+'" placeholder="Dni" required><br>'+
                                            '<input type="text" name="nombreCliente" id="nombreCliente" value="'+info.nombre+'" placeholder="Nombre" onkeypress="return soloLetras(event)" onpaste="return false" required><br>'+
                                            '<input type="text" name="apellidoCliente" id="apellidoCliente" value="'+info.apellidoPaterno+'" placeholder="Apellidos Paterno" onkeypress="return soloLetras(event)" onpaste="return false" required><br>'+
                                            '<input type="text" name="apellidoClient" id="apellidoClient" value="'+info.apellidoMaterno+'" placeholder="Apellidos Materno" onkeypress="return soloLetras(event)" onpaste="return false" required><br>'+
   ...
   function actualizarCliente(){
    ...
    var apellidoPaterno = $('#apellidoCliente').val();
    var apellidoMarterno = $('#apellidoClient').val();
    var telefono = $('#telefonoCliente').val();
    var direccion = $('#direccionCliente').val();
    if (Dni.length < 8){
        $('.alertAddProduct').html('<p style="color:red;">El Dni debe ser de 8 caracteres como mínimo.</p>');
    ...
    if (telefono.length < 9){
        $('.alertAddProduct').html('<p style="color:red;">El telefono debe ser de 9 caracteres como mínimo.</p>');
        $('.alertAddProduct').slideDown();
        return false;
    }
            ...
            //console.log(response);            
                if (response != 'error') {
                    ...
                    $('.bodyModal').html('<form action="" method="post" name="form_add_product" id="form_add_product" onsubmit="event.preventDefault(); eliminarCliente();">'+
                                            ...
                                            '<h2 class="nameProducto">'+info.Dni+'</h2> <br>'+
                                            '<div class="alert alertAddProduct"></div>'+
                                            '<a href="#" class="btn_ok closeModal" onclick="coloseModal(); "><i class="fas fa-ban"></i> Cerrar</a>'+
...
function nuevoCliente(){
    ...
    var direccion = $('#direccionCliente').val();
    if (Dni.length < 5){
        $('.alertAddProduct').html('<p style="color:red;">El Dni debe ser de 5 caracteres como mínimo.</p>');
        $('.alertAddProduct').slideDown();
        return false;
    }
    if (nombre.length < 4){
...
function listaUsuario(pagina,busqueda){
   ...
   function editarUsuario(id)
            ...
            //console.log(response);            
                if (response != 'error') {
                    ...
                    $('.bodyModal').html('<form action="" method="post" name="form_add_product" id="form_add_product" onsubmit="event.preventDefault(); actualizarUsuario();">'+
                                            ...
                                            '<input type="hidden" name="idCliente" value="'+info.usuario.idCliente+'">'+
                                            ...
                                            '<select name="rolUsuario" id="rolUsuario" required><option value="'+'">'+info.usuario.rol+'</option>'+info.rol+'</select><br>'+
                                            '<div class="alert alertAddProduct"></div>'+
                                            '<a href="#" class="btn_ok closeModal" onclick="coloseModal(); "><i class="fas fa-ban"></i> Cerrar</a>'+
                                            '<button type="submit" class="btn_new"><i class="fas fa-plus"></i> Guardar</button>'+              
                                        '</form>');
    ...
    //Actualizar usuarios  
    //Modal editar cliente// actualizarUsuario(id)
