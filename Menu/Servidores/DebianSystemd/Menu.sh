...
echo -e $red "[ X ] xterm  -> ${RedF} no se puedo encontrar"
echo -e $yellow "[ ! ] Desea instalar xterm "
...
if [ "$?" -eq "0" ]; then
echo -e $yellow "[ ✔ ] youtube-dl............${green}[ Encontrado ]"
which youtube-dl > /dev/null 2>&1
sleep 3
else
echo -e $red "[ X ] youtube-dl  -> ${RedF} no se puedo encontrar"
echo -e $yellow "[ ! ] Desea instalar youtube-dl "
...
while :
do
figlet YAIBRAMIR V2.6| lolcat -a -d 20
