...
VerificaTipoMenu
echo -e -n "${yellow}
$grn [1] $yellow Apache con Localhost.run 
$grn [2] $yellow APache con Ngrok      
$grn [3] $yellow Apache con Cloudflare
$grn [4] $yellow Apache con LocalTunnel 
$grn [5] $yellow Apache con LocalXpose 
$grn [6] $yellow Apache con Serveo.Net
$grn [7] $yellow Apache con Localhost                                         
